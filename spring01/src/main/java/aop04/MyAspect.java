...
public class MyAspect {
	...
	public void myBefore(JoinPoint joinPoint) {
		...
		for (Object o : args) {
			System.out.println(" myBefore pointcut의 인자값 확인 => " + o);
		} // for
	} // myBefore
	...
	public void myAfter_returning(Object result) {
		...
		System.out.println(" myAfter_returning pointcut의 결과값 => " + result);
		// 이 매개변수 result는 값을 전달받았을 뿐, myAfter_returning의 지역변수
		// 따라서 pointcut의 return값에는 영향 없음
		result += "return Value Change";
	}

	// After_throwing 핵심적 기능 비정상종료
