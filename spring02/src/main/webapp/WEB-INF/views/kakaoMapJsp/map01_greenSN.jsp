...
=> Javascript 키 : 2f0d99c48a23b8c69b5cb4a3df6fdb92 (적용)

=> http://apis.map.kakao.com/web/sample/ 
=> 객체및 사용법 안내 : https://apis.map.kakao.com/web/documentation/
-->	
<script type="text/javascript" 
	    src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2f0d99c48a23b8c69b5cb4a3df6fdb92&libraries=services">
</script>	
...
var address = '서울특별시 강남구 광평로51길 22' ;
